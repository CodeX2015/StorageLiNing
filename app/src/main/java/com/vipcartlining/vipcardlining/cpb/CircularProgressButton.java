...
public class CircularProgressButton extends Button {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mStrokeWidth = (int) getContext().getResources().getDimension(R.dimen.d_cpb_stroke_width);
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int blue = getColor(R.color.c_cpb_blue);
            int white = getColor(R.color.c_cpb_white);
            int grey = getColor(R.color.c_cpb_grey);
